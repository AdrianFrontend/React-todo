...
const App = () => {
	...
	const onToggleDone = (id) => {
		...
		setTasksData(toggleTaskState(tasksData, idx, "active", (tasksData[idx].active = !tasksData[idx].active)));
	};
	...
	const onSubmitChanges = (changes, id) => {
		const idx = tasksData.findIndex((i) => i.id === id);

		toggleTaskState(tasksData, idx, "label", (tasksData[idx].label = changes));
	};
